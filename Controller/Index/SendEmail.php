...
namespace ArslanFarrukh\ShareCart\Controller\Index;
...
use ArslanFarrukh\ShareCart\Helper\GenerateSharingUrl;
...
class SendEmail extends AbstractHelper implements ActionInterface
{
    ...
    public function sendEmail() : void
    {
        ...
        $emailSubject = $this->scopeConfig->getValue('arslan/share_cart/email_subject');
        $followUpText = $this->scopeConfig->getValue('arslan/share_cart/email_followup_message');
